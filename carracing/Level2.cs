...
namespace carracing
{
    public partial class Level2 : Form
    {
        ...
        int carspeed = 3;
        int score = 0;
        int targetScore = 30; // Số điểm cần đạt để qua màn
        ...
        void totalscore()
        {
            ...
            if (score >= targetScore)
            {
                ...
                MessageBox.Show(" next level 3!", "Level Up", MessageBoxButtons.OK, MessageBoxIcon.Information);

                Level3 level3 = new Level3();
                level3.Show(); // Hiện màn chơi mới
