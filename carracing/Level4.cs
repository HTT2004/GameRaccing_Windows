...
namespace carracing
{
    public partial class Level4 : Form
    {
        ...
        int carspeed = 3;
        int score = 0;
        int targetScore = 50; // Số điểm cần đạt để qua màn
        ...
        void linemove(int speed)
        {
            ...
            if (pictureBox6.Top > 500) pictureBox6.Top = 0;
            else pictureBox6.Top += speed;

            if (pictureBox8.Top > 500) pictureBox8.Top = 0;
            else pictureBox8.Top += speed;

            if (pictureBox10.Top > 500) pictureBox10.Top = 0;
            else pictureBox10.Top += speed;

            if (pictureBox7.Top > 500) pictureBox7.Top = 0;
            else pictureBox7.Top += speed;

            if (pictureBox9.Top > 500) pictureBox9.Top = 0;
            else pictureBox9.Top += speed;

            if (pictureBox11.Top > 500) pictureBox11.Top = 0;
            else pictureBox11.Top += speed;

            if (pictureBox12.Top > 500) pictureBox12.Top = 0;
            else pictureBox12.Top += speed;

            if (pictureBox13.Top > 500) pictureBox13.Top = 0;
            else pictureBox13.Top += speed;

            if (pictureBox14.Top > 500) pictureBox14.Top = 0;
        ...
        void totalscore()
        {
            ...
            if (score >= targetScore)
            {
                ...
                MessageBox.Show(" YOU WIN!!!", "Level Up", MessageBoxButtons.OK, MessageBoxIcon.Information);

                //Level4 level4 = new Level4();
                //level4.Show(); // Hiện màn chơi mới
